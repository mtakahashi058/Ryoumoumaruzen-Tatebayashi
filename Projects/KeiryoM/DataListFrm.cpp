...
void __fastcall TDataListForm::FormShow(TObject *Sender)
{
    if (first_){
		...
		FromDateCheckBox->Color = clWindow;
		ToDateCheckBox->Color   = clWindow;
		ClearButton->Click();
...
void __fastcall TDataListForm::btnOkClick(TObject *Sender)
{
    ...
    int lineno = Q_Keiryo->FieldByName("行No")->AsInteger;
    if (lineno != 1){
    	...
    	selected_id = Q_Keiryo->FieldByName("計量ID")->AsInteger;
    }
...
void __fastcall TDataListForm::ClearButtonClick(TObject *Sender)
{
	...
	dtpDateFrom->OnClick(NULL);
	dtpDateTo->Date   = now;
	dtpDateTo->OnClick(NULL);
...
//---------------------------------------------------------------------------
/*************** comctrl.pasが上手く反映されないので力技 *******************/
void __fastcall TDataListForm::dtpDateFromClick(TObject *Sender)
{
	FromDateCheckBox->Checked = dtpDateFrom->Checked;
}
//---------------------------------------------------------------------------
void __fastcall TDataListForm::dtpDateToClick(TObject *Sender)
{
	ToDateCheckBox->Checked = dtpDateTo->Checked;
}
//---------------------------------------------------------------------------
void __fastcall TDataListForm::FromDateCheckBoxClick(TObject *Sender)
{
	dtpDateFrom->Checked = FromDateCheckBox->Checked;
}
//---------------------------------------------------------------------------
void __fastcall TDataListForm::ToDateCheckBoxClick(TObject *Sender)
{
	dtpDateTo->Checked = ToDateCheckBox->Checked;
}
/***************************************************************************/
//---------------------------------------------------------------------------
