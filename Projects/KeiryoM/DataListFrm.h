...
__published:    // IDE 管理のコンポーネント
	...
	TCheckBox *FromDateCheckBox;
	TCheckBox *ToDateCheckBox;
	...
	void __fastcall FormKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
	void __fastcall dtpDateFromClick(TObject *Sender);
	void __fastcall dtpDateToClick(TObject *Sender);
	void __fastcall FromDateCheckBoxClick(TObject *Sender);
	void __fastcall ToDateCheckBoxClick(TObject *Sender);
private:    // ユーザー宣言
