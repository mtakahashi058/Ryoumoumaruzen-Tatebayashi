...
__published:	// IDE 管理のコンポーネント
    ...
    TButton *TokuRefButton;
    TButton *Item1RefButton;
    TButton *Item2RefButton;
	TPanel *Panel1;
	TBevel *Bevel5;
	TCobEdit *TareEdit;
	TPanel *Panel2;
    ...
    TButton *HinRefButton;
    TCobEdit *CarNameEdit;
    TButton *CarRefButton;
    TButton *ClearButton;
    TButton *N24TPCardsButton;
	...
	void __fastcall TokuRefButtonClick(TObject *Sender);
	void __fastcall Item1RefButtonClick(TObject *Sender);
	void __fastcall Item2RefButtonClick(TObject *Sender);
	void __fastcall TokuEditKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
	void __fastcall Item1EditKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
	void __fastcall Item2EditKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
	void __fastcall IssueButtonClick(TObject *Sender);
    void __fastcall HinEditChange(TObject *Sender);
    void __fastcall HinEditKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
    void __fastcall CarRefButtonClick(TObject *Sender);
    void __fastcall HinRefButtonClick(TObject *Sender);
    ...
    void __fastcall N24TPCardsButtonClick(TObject *Sender);
...
private:	// ユーザー宣言
    ...
    BOOL __fastcall SendCommand(SCARDHANDLE hCard);
