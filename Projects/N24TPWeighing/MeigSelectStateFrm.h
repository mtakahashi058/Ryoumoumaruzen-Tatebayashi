...
#ifndef MeigSelectStateFrmH
#define MeigSelectStateFrmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TMeigSelectForm : public AbstractStateForm
{
...
public:		// ユーザー宣言
	__fastcall TMeigSelectForm(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TMeigSelectForm *MeigSelectForm;
//---------------------------------------------------------------------------
#endif
