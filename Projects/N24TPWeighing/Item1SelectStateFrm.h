...
#ifndef Item1SelectStateFrmH
#define Item1SelectStateFrmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TItem1SelectForm : public AbstractStateForm
{
...
public:		// ユーザー宣言
	__fastcall TItem1SelectForm(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TItem1SelectForm *Item1SelectForm;
//---------------------------------------------------------------------------
#endif
