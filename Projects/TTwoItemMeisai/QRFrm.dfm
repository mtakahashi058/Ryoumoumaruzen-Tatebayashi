object QRForm: TQRForm
  ...
  object QuickRep: TQuickRep
    ...
    object PageHeaderBand: TQRBand
      ...
      object TitleLabel: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '2'#38917#30446#21029#26126#32048#34920#12304#21462#24341#12305
        Color = clWhite
        Font.Charset = SHIFTJIS_CHARSET
        Font.Color = clWindowText
        Font.Height = -17
  ...
  object Query: TADOQuery
    ...
    SQL.Strings = (
      'SELECT'
      #9#24471#24847#20808'ID AS '#38917#30446'ID1, '#24471#24847#20808#12467#12540#12489' AS '#38917#30446#12467#12540#12489'1, '#24471#24847#20808#21517#31216' AS '#38917#30446#30053#31216'1,'
      ...
      #9'V_'#21462#24341
      'WHERE'
      #9#21462#24341#26085' BETWEEN 20100701 AND 20100731'
      'AND'
      #9#23436#20102#21306#20998' = 1'
      'ORDER BY'
      #9#38917#30446#12467#12540#12489'1, '#38917#30446#12467#12540#12489'2, '#21462#24341#26085', '#20253#31080'No'
      '')
    Left = 8
    Top = 8
  ...
  object MeigaraQuery: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9#21336#20301#12467#12540#12489', MAX('#21336#20301#12510#12473#12479#21517#31216') AS '#21336#20301#21517#31216','
      #9'SUM('#25968#37327') AS '#25968#37327','
      #9'SUM('#37329#38989') AS '#37329#38989
      'FROM'
      #9'V_'#21462#24341
      'WHERE'
      #9#21462#24341#26085' BETWEEN 20110601 AND 20110630'
      'AND'
      #9#23436#20102#21306#20998' = 1'
      'GROUP BY'
      #9#21697#30446#12467#12540#12489', '#21336#20301#12467#12540#12489)
    Left = 64
    Top = 8
    ...
    object MeigaraQueryDSDesigner3: TIntegerField
      FieldName = #21336#20301#12467#12540#12489
    end
    object MeigaraQueryDSDesigner5: TStringField
      FieldName = #21336#20301#21517#31216
      ReadOnly = True
      Size = 10
    end
    object MeigaraQueryDSDesigner6: TBCDField
      FieldName = #25968#37327
      ReadOnly = True
      DisplayFormat = '#,##0.###'
      Precision = 32
