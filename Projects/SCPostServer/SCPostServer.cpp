...
#pragma hdrstop
//---------------------------------------------------------------------------
USEFORM("MainFrm.cpp", SCPostForm);
...
{
    HWND main_wnd = ::FindWindow("TSCPostForm", "SC操作ポスト制御");
    if (main_wnd)
        return 0;
    ...
    try
    {
         ...
         Application->Title = "SC操作ポスト制御";
         Application->CreateForm(__classid(TDM), &DM);
         Application->CreateForm(__classid(TSCPostForm), &SCPostForm);
