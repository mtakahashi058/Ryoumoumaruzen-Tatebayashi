...
#ifndef Item2EditFrmH
#define Item2EditFrmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include "DMFrm.h"
//---------------------------------------------------------------------------
class TItem2EditForm : public TForm
{
...
public:		// ユーザー宣言
	__fastcall TItem2EditForm(TComponent* Owner);

	int __fastcall ShowModalWithId(int id);
};
//---------------------------------------------------------------------------
extern PACKAGE TItem2EditForm *Item2EditForm;
//---------------------------------------------------------------------------
#endif
