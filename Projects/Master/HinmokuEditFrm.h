...
#ifndef HinmokuEditFrmH
#define HinmokuEditFrmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include "DMFrm.h"
//---------------------------------------------------------------------------
class THinmokuEditForm : public TForm
{
__published:	// IDE 管理のコンポーネント
	...
	TAction *Action4;
	TPanel *HinBunruiPanel;
	TLabel *HinBunruiLabel;
	TSpeedButton *HinBunruiSearchButton;
	TCobEdit *HinBunruiCodeEdit;
	TCobEdit *HinBunruiNameEdit;
	TPanel *IoDivPanel;
	TLabel *Label5;
	...
	void __fastcall UseDivComboBoxKeyDown(TObject *Sender, WORD &Key,
          TShiftState Shift);
	void __fastcall HinBunruiCodeEditChange(TObject *Sender);
	void __fastcall HinBunruiSearchButtonClick(TObject *Sender);
	void __fastcall HinBunruiCodeEditEnter(TObject *Sender);
	void __fastcall IoDivComboBoxEnter(TObject *Sender);
      void __fastcall Action3Execute(TObject *Sender);
      void __fastcall Action1Execute(TObject *Sender);
	void __fastcall ChoseiEditEnter(TObject *Sender);
	void __fastcall CodePanelEnter(TObject *Sender);
	void __fastcall CodePanelExit(TObject *Sender);
private:	// ユーザー宣言
	int id_, page_;
	bool is_edit_;
	MasterMap use_div_map_, io_div_map_;
	AnsiString hinbun_, keyfield_;
...
public:		// ユーザー宣言
	__fastcall THinmokuEditForm(TComponent* Owner);

	int __fastcall ShowModalWithId(int id);
};
//---------------------------------------------------------------------------
extern PACKAGE THinmokuEditForm *HinmokuEditForm;
//---------------------------------------------------------------------------
#endif
