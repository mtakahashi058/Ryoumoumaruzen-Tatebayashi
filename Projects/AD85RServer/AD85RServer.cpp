...
#pragma hdrstop
//---------------------------------------------------------------------------
USEFORM("MainFrm.cpp", AD4385RPostForm);
...
{
    HWND main_wnd = ::FindWindow("TAD4385PostForm", "AD4385 操作ポスト制御");
    if (main_wnd)
        return 0;
    ...
    try
    {
         ...
         Application->Title = "AD4385 操作ポスト制御";
         Application->CreateForm(__classid(TDM), &DM);
         Application->CreateForm(__classid(TAD4385RPostForm), &AD4385RPostForm);
