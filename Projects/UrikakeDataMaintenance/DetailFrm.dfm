object DetailForm: TDetailForm
  ...
  Caption = #65291#65291#65291' '#12487#12540#12479#35443#32048' '#65291#65291#65291
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 64
    Height = 15
    Caption = #32224#20999#26085#65306
    Font.Charset = SHIFTJIS_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = #65325#65331' '#12468#12471#12483#12463
  ...
  object Label3: TLabel
    ...
    Width = 64
    Height = 15
    Caption = #35531#27714#20808#65306
    Font.Charset = SHIFTJIS_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = #65325#65331' '#12468#12471#12483#12463
  ...
  object btnSeikyu: TSpeedButton
    ...
    OnClick = btnSeikyuClick
  end
  object cedtID: TCobEdit
    Left = 415
    Top = 94
    Width = 81
    Height = 23
  ...
  object cedtSeikyuCode: TCobEdit
    Left = 88
    Top = 100
    Width = 53
    Height = 23
  ...
  object cedtSeikyuName: TCobEdit
    Left = 88
    Top = 126
    Width = 408
    Height = 23
  ...
  object GroupBox1: TGroupBox
    ...
    object Label4: TLabel
      ...
      Width = 64
      Height = 15
      Caption = #21069#26376#27531#39640
    end
    ...
    object Label6: TLabel
      ...
      Height = 15
      Alignment = taRightJustify
      Caption = #24403#26376#35519#25972#38989
    end
    object Label7: TLabel
      ...
      Height = 15
      Alignment = taRightJustify
      Caption = #24403#26376#32368#36234#38989
    end
    object Label8: TLabel
      ...
      Width = 80
      Height = 15
      Caption = #24403#26376#22770#19978#38989
    end
    object Label9: TLabel
      ...
      Height = 15
      Alignment = taRightJustify
      Caption = #24403#26376#28040#36027#31246#38989
    end
    object Label10: TLabel
      ...
      Width = 64
      Height = 15
      Caption = #24403#26376#27531#39640
    end
    object TaxLabel: TLabel
      ...
      Height = 15
      Alignment = taRightJustify
      Caption = #65288#38750#35506#31246#65289
    end
    object cedtZenSeikyu: TCobEdit
      Left = 116
      Top = 17
      Width = 92
      Height = 23
      ...
      TabOrder = 0
      Text = '1234567890'
      OnChange = cedtZenSeikyuChange
      IsInsert = True
      Alignment = taRightJustify
    end
    object cedtKonNyukin: TCobEdit
      Left = 116
      Top = 41
      Width = 92
      Height = 23
    ...
    object cedtKonKurikosi: TCobEdit
      Left = 116
      Top = 88
      Width = 92
      Height = 23
      ...
      TabOrder = 3
      Text = '1234567890'
      OnChange = cedtKonUriageChange
      IsInsert = True
      Alignment = taRightJustify
    end
    object cedtKonUriage: TCobEdit
      Left = 357
      Top = 17
      Width = 92
      Height = 23
    ...
    object cedtKonShohizei: TCobEdit
      Left = 357
      Top = 41
      Width = 92
      Height = 23
    ...
    object cedtKonSeikyu: TCobEdit
      ...
      TabOrder = 6
      Text = '1234567890'
      OnKeyDown = cedtKonSeikyuKeyDown
      IsInsert = True
      Alignment = taRightJustify
    end
  end
  object RenzokuCheckBox: TCheckBox
    ...
    Width = 85
    Height = 17
    Caption = #36899#32154#20837#21147
    TabOrder = 7
  end
  object SimekiribiMaskEdit: TMaskEdit
    Left = 90
    Top = 61
    Width = 87
    Height = 23
    ...
    TabOrder = 8
    Text = '    /  /  '
    OnExit = SimekiribiMaskEditExit
  end
  object SimekiribiPicker: TDateTimePicker
    Tag = 2
    Left = 175
    Top = 61
    Width = 20
    ...
    TabOrder = 9
    TabStop = False
    OnCloseUp = SimekiribiPickerCloseUp
    OnChange = SimekiribiPickerChange
    OnEnter = SimekiribiPickerEnter
    OnExit = SimekiribiPickerExit
  end
