...
#ifndef QRInnerChitFrmH
#define QRInnerChitFrmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TQRInnerChitForm : public TForm
{
...
private:	// ユーザー宣言
public:		// ユーザー宣言
    __fastcall TQRInnerChitForm(TComponent* Owner);
	void __fastcall Print(int keiryo_id);
};
//---------------------------------------------------------------------------
extern PACKAGE TQRInnerChitForm *QRInnerChitForm;
//---------------------------------------------------------------------------
#endif
