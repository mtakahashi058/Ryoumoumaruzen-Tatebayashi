...
//
//      void __fastcall CAD4401TcpThread::UpdateCaption()
//      {
...
__fastcall CAD4401TcpThread::CAD4401TcpThread(bool CreateSuspended, const WITcpInfo& info)
    : TThread(CreateSuspended), info_(info),socket_(0)
{
}
//---------------------------------------------------------------------------
void __fastcall CAD4401TcpThread::Execute()
{
    MSG msg;
...
//---------------------------------------------------------------------------
void __fastcall CAD4401TcpThread::OnSocketError(const AnsiString& message)
{
...
//---------------------------------------------------------------------------
void __fastcall CAD4401TcpThread::OnSocketRead(const AnsiString& data)
{
