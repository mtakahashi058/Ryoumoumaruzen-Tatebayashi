...
//
//  void __fastcall TSMU790Thread::UpdateCaption()
//  {
...
//
//---------------------------------------------------------------------------
__fastcall TSMU790Thread::TSMU790Thread(bool CreateSuspended, const WICommInfo& info)
    : TThread(CreateSuspended), info_(info)
{
}
//---------------------------------------------------------------------------
bool __fastcall TSMU790Thread::formatMessage(std::string& msg)
{
    LPVOID buff;
...
//---------------------------------------------------------------------------
void __fastcall TSMU790Thread::Execute()
{
