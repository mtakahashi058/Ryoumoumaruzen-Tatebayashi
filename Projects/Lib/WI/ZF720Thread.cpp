...
//
//  void __fastcall TZF720Thread::UpdateCaption()
//  {
...
//
//---------------------------------------------------------------------------
__fastcall TZF720Thread::TZF720Thread(bool CreateSuspended, const WICommInfo& info)
    : TThread(CreateSuspended), info_(info)
{
}
//---------------------------------------------------------------------------
bool __fastcall TZF720Thread::formatMessage(std::string& msg)
{
    LPVOID buff;
...
//---------------------------------------------------------------------------
void __fastcall TZF720Thread::CancelZero()
{
    OVERLAPPED o_write;
    COMSTAT stat;
    DWORD event;
...
//---------------------------------------------------------------------------
void __fastcall TZF720Thread::SetZero()
{
    OVERLAPPED o_write;
    COMSTAT stat;
    DWORD event;
...
//---------------------------------------------------------------------------
void __fastcall TZF720Thread::Execute()
{
    ...
    while (!Terminated){
        ...
        if (PeekMessage(&msg, 0, WIM_ZEROSET, WIM_CANCELZERO, PM_REMOVE)){
