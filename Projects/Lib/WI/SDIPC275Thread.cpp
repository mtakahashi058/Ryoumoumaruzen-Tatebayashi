...
//
//  void __fastcall TSDIPC275Thread::UpdateCaption()
//  {
...
//
//---------------------------------------------------------------------------
__fastcall TSDIPC275Thread::TSDIPC275Thread(bool CreateSuspended, const WICommInfo& info)
    : TThread(CreateSuspended), info_(info)
{
}
//---------------------------------------------------------------------------
bool __fastcall TSDIPC275Thread::formatMessage(std::string& msg)
{
    LPVOID buff;
...
//---------------------------------------------------------------------------
void __fastcall TSDIPC275Thread::Execute()
{
